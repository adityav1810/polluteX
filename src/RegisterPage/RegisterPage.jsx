...
// FOR MULTSELECT OPTION, NOT WORKING AS OF NOW FIND A WAY ON YOUR OWN GUYS LOL!
// THE CODE BELOW IS SOMEWHAT CORRECT BUT IT NEEDS TO BE CUSTOMIZED FURTHER
 ...
 //MULTISELECT ENDS  
    ...
    handleSubmit(event) {
        ...
        alert(this.state.dropdown.value)
    ...
    render() {
        ...
        return (
            <div className="col-md-6 col-md-offset-3" style={{fontSize:"20px"}}>
                <font color="white"><h2 style={{fontSize:"60px"}}>Register</h2>
                <form name="form" onSubmit={this.handleSubmit}>
                    ...
                    <div className={'form-group' + (submitted && !user.dropdown ? ' has-error' : '')}>
                       <label htmlFor="dropdown">Pick your favorite flavor:</label>
                       <font style={{fontSize:"20px", color:"black"}}>
                            <select multiple={true} value={this.state.value} onChange={this.handleChange}>
                                ...
                                <option value="dustallergies">Allergies Due to Dust</option>
                                <option value="lungcollapse">Lung Collapse</option>
